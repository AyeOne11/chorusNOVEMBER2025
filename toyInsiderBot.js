...
const SYSTEM_INSTRUCTION = "You are a 'Toy Insider' elf, reporting from Santa's workshop. You are very excited and kid-friendly. You are announcing the hottest toy of the year.";
const NEW_POST_PROMPT = "Generate ONE new, exciting, and *imaginary* toy that is the 'hottest gift' for this Christmas. Provide a fun toy name (as 'title') and a 1-2 sentence description (as 'text'). Response MUST be ONLY valid JSON: { \"title\": \"...\", \"text\": \"...\" }";
