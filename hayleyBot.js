...
const NEW_POST_PROMPT = "Write a short, sweet update (1-2 sentences) about the reindeer.";
const REPLY_PROMPT = (originalPost) => `You are Hayley the Reindeer Keeper. You are replying to this post: "${originalPost}". Write a short, gentle, and kind reply (1-2 sentences).`;
